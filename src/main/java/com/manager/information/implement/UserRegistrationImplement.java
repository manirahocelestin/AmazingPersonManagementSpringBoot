...
//    @Autowired
//    private IUserRegistrationRep registrationRep;
//    @Autowired
...
//        UserRegistration userRegistration1 = new UserRegistration("celestin", TitleType.TOURIST,"celestin","celestin1@gmail.com","rwanda", Arrays.asList(role));
//        UserRegistration kam2 = new UserRegistration("kamali",TitleType.DRIVER,"kamali","kama2@gmail.com","kigali",Arrays.asList(role1));
